...
.hai{
    width: 100%;
    background: linear-gradient(to top, rgba(0,0,0,0)50%, rgba(0,0,0,0)50%),url("../images/mainbg.jpg");
...
.content-table tbody tr{
    border-bottom: 1px solid #03918c;
}
...
<div class="hai">
        <div class="navbar">
            <div class="icon">
                <h2 class="logo">vehicle</h2>
            </div>
            <div class="menu">
                <ul>
                    <li><a href="adminvehicle.php">VEHICLE MANAGEMENT</a></li>
                    <li><a href="./emp/index.php">EMPLOYEES</a></li>
